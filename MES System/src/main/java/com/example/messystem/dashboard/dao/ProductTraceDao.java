...
public class ProductTraceDao {
    ...
    public long insert(MesProductTrace trace) throws SQLException {
        String sql = "INSERT INTO mes_product_trace (trace_code, order_id, task_id, work_order_id, batch_no, trace_status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = Db.getConnection(); PreparedStatement ps = conn.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setString(6, trace.traceStatus());
            ps.setObject(7, trace.createdAt());
            ps.executeUpdate();
    ...
    public Optional<MesProductTrace> findById(long id) throws SQLException {
        String sql = "SELECT trace_id, trace_code, order_id, task_id, work_order_id, batch_no, trace_status, created_at FROM mes_product_trace WHERE trace_id = ?";
    ...
    public Optional<MesProductTrace> findByTraceCode(String traceCode) throws SQLException {
        String sql = "SELECT trace_id, trace_code, order_id, task_id, work_order_id, batch_no, trace_status, created_at FROM mes_product_trace WHERE trace_code = ?";
        try (Connection conn = Db.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public List<MesProductTrace> findByWorkOrderId(long workOrderId) throws SQLException {
        String sql = "SELECT trace_id, trace_code, order_id, task_id, work_order_id, batch_no, trace_status, created_at FROM mes_product_trace WHERE work_order_id = ?";
        try (Connection conn = Db.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public List<MesProductTrace> findAll() throws SQLException {
        String sql = "SELECT trace_id, trace_code, order_id, task_id, work_order_id, batch_no, trace_status, created_at FROM mes_product_trace";
