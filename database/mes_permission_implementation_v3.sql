...
VALUES
    ...
    ('master.read', '查看产品与基础主数�?, 'master', 'master_data', 'read', 'LOW'),
    ('master.manage', '维护产品与基础主数�?, 'master', 'master_data', 'manage', 'HIGH'),
    ('planning.read', '查看订单计划与全部工�?, 'planning', 'plan', 'read', 'LOW'),
    ('planning.work_order.read', '查看本人相关制造工�?, 'planning', 'work_order', 'read_own', 'LOW'),
    ...
    ('warehouse.inventory.adjust', '调整库存并写入流�?, 'warehouse', 'inventory', 'adjust', 'CRITICAL'),
    ...
    ('production.report.update_own', '修改本人待审核报�?, 'production', 'work_report', 'update_own', 'MEDIUM'),
    ...
    ('production.wage.read_summary', '查看计件工资汇�?, 'production', 'piecework_wage', 'read_summary', 'HIGH'),
    ...
    ('quality.inspection.create', '创建质检�?, 'quality', 'quality_inspection', 'create', 'HIGH'),
    ...
    ('process.read', '查看工艺标准和参�?, 'process', 'process_standard', 'read', 'LOW'),

    ('equipment.read', '查看设备和维修数�?, 'equipment', 'equipment_business', 'read', 'LOW'),
    ...
    ('equipment.maintenance.assign', '创建并派发维修工�?, 'equipment', 'maintenance_order', 'assign', 'HIGH'),
    ('equipment.maintenance.execute', '执行本人维修工单', 'equipment', 'maintenance_order', 'execute', 'MEDIUM'),
    ('equipment.maintenance.accept', '验收维修结果并恢复设�?, 'equipment', 'maintenance_order', 'accept', 'HIGH'),
...
WITH grants(role_code, permission_code) AS (
    ...
    ('WORKSHOP_MANAGER','equipment.fault.report'),
