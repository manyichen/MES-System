...
WITH grants(role_code, permission_code) AS (
    ...
    ('WORKSHOP_MANAGER','warehouse.requisition.approve'), ('WORKSHOP_MANAGER','production.read'),
    ('WORKSHOP_MANAGER','production.report_review'), ('WORKSHOP_MANAGER','production.wage.read_summary'),
